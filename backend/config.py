...
class Config:
    ...
    if database_url:
        ...
        # SQLite fallback — works both locally and on Render
        if os.getenv('RENDER'):
    ...
    CORS_ORIGINS = os.getenv('CORS_ORIGINS', 'http://localhost:8000,http://127.0.0.1:8000,https://ticket-creation-rho.vercel.app,https://ticket-creation-c1xe.vercel.app,https://*.vercel.app').split(',')
